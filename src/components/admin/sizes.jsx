        ...
        : <div className='pa4 avenir'>
          <div className='overflow-auto'>
            <table className='f5 w-100 mw8 center'
              ...
              <thead>
                <tr>
                  {['Length (m)', 'Width (m)'].map((value, index) =>
                    <th key={index}
    ...
    return (
      <article className='avenir center mw5 mw6-ns hidden ba mv4'>
        <div className='pa3 bt'>
          <label className='f6 db mb2'>Length (m)</label>
          <input className='input-reset ba b--black-20 pa2 mb2 db w-100'
            type='number'
            value={this.state.size.length}
            onChange={(e) => this.handleSize(e.target.value, this.state.size.width)} />
          <label className='f6 db mb2'>Width (m)</label>
          <input className='input-reset ba b--black-20 pa2 mb2 db w-100'
            type='number'
            value={this.state.size.width}
            onChange={(e) => this.handleSize(this.state.size.length, e.target.value)} />
          <div>
